-- Vehicle Models Seed Migration
-- Source: NHTSA vPIC API, model year 2024
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Ridgeline', 'honda-ridgeline', 'ridgeline' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Gold Wing', 'honda-gold-wing', 'goldwing' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Africa Twin', 'honda-africa-twin', 'africatwin' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Gold Wing Tour', 'honda-gold-wing-tour', 'goldwingtour' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Rebel 1100', 'honda-rebel-1100', 'rebel1100' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Rebel 500', 'honda-rebel-500', 'rebel500' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Rebel 300', 'honda-rebel-300', 'rebel300' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CBR600RR', 'honda-cbr600rr', 'cbr600rr' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CBR1000RR', 'honda-cbr1000rr', 'cbr1000rr' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CBR650R', 'honda-cbr650r', 'cbr650r' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CBR500R', 'honda-cbr500r', 'cbr500r' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CB500F', 'honda-cb500f', 'cb500f' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CB500X', 'honda-cb500x', 'cb500x' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CB300R', 'honda-cb300r', 'cb300r' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CB650R', 'honda-cb650r', 'cb650r' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'NX500', 'honda-nx500', 'nx500' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF300L', 'honda-crf300l', 'crf300l' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF250L', 'honda-crf250l', 'crf250l' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF250R', 'honda-crf250r', 'crf250r' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF450R', 'honda-crf450r', 'crf450r' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF450X', 'honda-crf450x', 'crf450x' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF250RX', 'honda-crf250rx', 'crf250rx' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF250F', 'honda-crf250f', 'crf250f' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF125F', 'honda-crf125f', 'crf125f' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF125FB', 'honda-crf125fb', 'crf125fb' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF150F', 'honda-crf150f', 'crf150f' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF150R', 'honda-crf150r', 'crf150r' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF150RB', 'honda-crf150rb', 'crf150rb' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF110F', 'honda-crf110f', 'crf110f' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CRF50F', 'honda-crf50f', 'crf50f' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'XR650L', 'honda-xr650l', 'xr650l' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'XR150L', 'honda-xr150l', 'xr150l' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Grom', 'honda-grom', 'grom' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Monkey', 'honda-monkey', 'monkey' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Super Cub', 'honda-super-cub', 'supercub' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Trail125', 'honda-trail125', 'trail125' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Navi', 'honda-navi', 'navi' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Ruckus', 'honda-ruckus', 'ruckus' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'PCX150', 'honda-pcx150', 'pcx150' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'ADV160', 'honda-adv160', 'adv160' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Forza', 'honda-forza', 'forza' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Giorno', 'honda-giorno', 'giorno' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Metropolitan', 'honda-metropolitan', 'metropolitan' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'SCL500', 'honda-scl500', 'scl500' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'NM4', 'honda-nm4', 'nm4' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'NC750X', 'honda-nc750x', 'nc750x' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Shadow Phantom', 'honda-shadow-phantom', 'shadowphantom' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Shadow Aero', 'honda-shadow-aero', 'shadowaero' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Africa Twin Adventure Sports', 'honda-africa-twin-adventure-sports', 'africatwinadventuresports' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Pioneer', 'honda-pioneer', 'pioneer' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Talon 1000', 'honda-talon-1000', 'talon1000' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Foreman', 'honda-foreman', 'foreman' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Foreman Rubicon', 'honda-foreman-rubicon', 'foremanrubicon' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Rancher', 'honda-rancher', 'rancher' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Recon', 'honda-recon', 'recon' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Rincon', 'honda-rincon', 'rincon' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Rubicon', 'honda-rubicon', 'rubicon' FROM vehicle_makes WHERE slug = 'honda' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'C-HR', 'toyota-c-hr', 'chr' FROM vehicle_makes WHERE slug = 'toyota' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Yaris', 'toyota-yaris', 'yaris' FROM vehicle_makes WHERE slug = 'toyota' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Celica', 'toyota-celica', 'celica' FROM vehicle_makes WHERE slug = 'toyota' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'F-650', 'ford-f-650', 'f650' FROM vehicle_makes WHERE slug = 'ford' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'F-750', 'ford-f-750', 'f750' FROM vehicle_makes WHERE slug = 'ford' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'E-350', 'ford-e-350', 'e350' FROM vehicle_makes WHERE slug = 'ford' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'E-450', 'ford-e-450', 'e450' FROM vehicle_makes WHERE slug = 'ford' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Focus', 'ford-focus', 'focus' FROM vehicle_makes WHERE slug = 'ford' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Flex', 'ford-flex', 'flex' FROM vehicle_makes WHERE slug = 'ford' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Fiesta', 'ford-fiesta', 'fiesta' FROM vehicle_makes WHERE slug = 'ford' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'GT MKII', 'ford-gt-mkii', 'gtmkii' FROM vehicle_makes WHERE slug = 'ford' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Silverado LD', 'chevrolet-silverado-ld', 'silveradold' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Silverado LTD', 'chevrolet-silverado-ltd', 'silveradoltd' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Suburban HD', 'chevrolet-suburban-hd', 'suburbanhd' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Impala', 'chevrolet-impala', 'impala' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Sonic', 'chevrolet-sonic', 'sonic' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Cruze', 'chevrolet-cruze', 'cruze' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Volt', 'chevrolet-volt', 'volt' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Bolt Incomplete', 'chevrolet-bolt-incomplete', 'boltincomplete' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Express', 'chevrolet-express', 'express' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'SS', 'chevrolet-ss', 'ss' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Aveo', 'chevrolet-aveo', 'aveo' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Onix', 'chevrolet-onix', 'onix' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Captiva Sport', 'chevrolet-captiva-sport', 'captivasport' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Caprice Police Vehicle', 'chevrolet-caprice-police-vehicle', 'capricepolicevehicle' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, '4500HD', 'chevrolet-4500hd', '4500hd' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, '4500XD', 'chevrolet-4500xd', '4500xd' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, '5500HD', 'chevrolet-5500hd', '5500hd' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, '5500XD', 'chevrolet-5500xd', '5500xd' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, '6500XD', 'chevrolet-6500xd', '6500xd' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, '7500XD', 'chevrolet-7500xd', '7500xd' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, '3500HG', 'chevrolet-3500hg', '3500hg' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, '4500HG', 'chevrolet-4500hg', '4500hg' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, '5500HG', 'chevrolet-5500hg', '5500hg' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, '5500XG', 'chevrolet-5500xg', '5500xg' FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'NV200', 'nissan-nv200', 'nv200' FROM vehicle_makes WHERE slug = 'nissan' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'NV', 'nissan-nv', 'nv' FROM vehicle_makes WHERE slug = 'nissan' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Grand Cherokee L', 'jeep-grand-cherokee-l', 'grandcherokeел' FROM vehicle_makes WHERE slug = 'jeep' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Wagoneer L', 'jeep-wagoneer-l', 'wagonerl' FROM vehicle_makes WHERE slug = 'jeep' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Grand Wagoneer L', 'jeep-grand-wagoneer-l', 'grandwagonerl' FROM vehicle_makes WHERE slug = 'jeep' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Sierra Limited', 'gmc-sierra-limited', 'sierralimited' FROM vehicle_makes WHERE slug = 'gmc' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Savana', 'gmc-savana', 'savana' FROM vehicle_makes WHERE slug = 'gmc' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'ELR', 'cadillac-elr', 'elr' FROM vehicle_makes WHERE slug = 'cadillac' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'SRX', 'cadillac-srx', 'srx' FROM vehicle_makes WHERE slug = 'cadillac' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Santa Fe XL', 'hyundai-santa-fe-xl', 'santafexl' FROM vehicle_makes WHERE slug = 'hyundai' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Nexo', 'hyundai-nexo', 'nexo' FROM vehicle_makes WHERE slug = 'hyundai' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'S 1000 RR', 'bmw-s-1000-rr', 's1000rr' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'S 1000 R', 'bmw-s-1000-r', 's1000r' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'S 1000 XR', 'bmw-s-1000-xr', 's1000xr' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'M 1000 RR', 'bmw-m-1000-rr', 'm1000rr' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'M 1000 R', 'bmw-m-1000-r', 'm1000r' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'M 1000 XR', 'bmw-m-1000-xr', 'm1000xr' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'R 1250 GS Adventure', 'bmw-r-1250-gs-adventure', 'r1250gsadventure' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'R 1300 GS', 'bmw-r-1300-gs', 'r1300gs' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'R 1250 RT', 'bmw-r-1250-rt', 'r1250rt' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'R 1250 R', 'bmw-r-1250-r', 'r1250r' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'R 1250 RS', 'bmw-r-1250-rs', 'r1250rs' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'R 18', 'bmw-r-18', 'r18' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'R 18 Classic', 'bmw-r-18-classic', 'r18classic' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'R 18 B', 'bmw-r-18-b', 'r18b' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'R 18 Roctane', 'bmw-r-18-roctane', 'r18roctane' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'R 18 Transcontinental', 'bmw-r-18-transcontinental', 'r18transcontinental' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'R 12', 'bmw-r-12', 'r12' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'R 12 nineT', 'bmw-r-12-ninet', 'r12ninet' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'K 1600 GT', 'bmw-k-1600-gt', 'k1600gt' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'K 1600 GTL', 'bmw-k-1600-gtl', 'k1600gtl' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'K 1600 B', 'bmw-k-1600-b', 'k1600b' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'F 800 GS', 'bmw-f-800-gs', 'f800gs' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'F 900 GS', 'bmw-f-900-gs', 'f900gs' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'F 900 GS Adventure', 'bmw-f-900-gs-adventure', 'f900gsadventure' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'F 900 R', 'bmw-f-900-r', 'f900r' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'F 900 XR', 'bmw-f-900-xr', 'f900xr' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'G 310 R', 'bmw-g-310-r', 'g310r' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'G 310 GS', 'bmw-g-310-gs', 'g310gs' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'C 400 GT', 'bmw-c-400-gt', 'c400gt' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'C 400 X', 'bmw-c-400-x', 'c400x' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CE 04', 'bmw-ce-04', 'ce04' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'CE 02', 'bmw-ce-02', 'ce02' FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'A-Class', 'mercedes-benz-a-class', 'aclass' FROM vehicle_makes WHERE slug = 'mercedes-benz' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'SC', 'lexus-sc', 'sc' FROM vehicle_makes WHERE slug = 'lexus' ON CONFLICT DO NOTHING;
...
-- VOLVO (passenger car / crossover models only)
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'V60CC', 'volvo-v60cc', 'v60cc' FROM vehicle_makes WHERE slug = 'volvo' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'V90CC', 'volvo-v90cc', 'v90cc' FROM vehicle_makes WHERE slug = 'volvo' ON CONFLICT DO NOTHING;
...
-- ALFA ROMEO
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Giulia', 'alfa-romeo-giulia', 'giulia' FROM vehicle_makes WHERE slug = 'alfa-romeo' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Diamante', 'mitsubishi-diamante', 'diamante' FROM vehicle_makes WHERE slug = 'mitsubishi' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'RCV', 'rivian-rcv', 'rcv' FROM vehicle_makes WHERE slug = 'rivian' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'EDV', 'rivian-edv', 'edv' FROM vehicle_makes WHERE slug = 'rivian' ON CONFLICT DO NOTHING;
...
-- PONTIAC (discontinued — no 2024 models found in NHTSA API)
-- SATURN (discontinued — no 2024 models found in NHTSA API)
-- SCION (discontinued — no 2024 models found in NHTSA API)
-- HUMMER (legacy brand — no 2024 models found in NHTSA API; GMC Hummer EV is listed under GMC above)
