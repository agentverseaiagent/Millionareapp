-- ============================================================
-- Garagetwits vehicle catalog
-- All makes, models (sourced from NHTSA vPIC 2024), and aliases.
-- Safe to re-run: all inserts use ON CONFLICT DO NOTHING.
--
-- To add models in the future: deploy + run sync-vehicles Edge Function.
-- New schema changes go in a new 000003_*.sql file.
-- ============================================================
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Prius Prime',       'toyota-prius-prime',       'priusprime'      FROM vehicle_makes WHERE slug = 'toyota' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'RAV4 Prime',        'toyota-rav4-prime',        'rav4prime'       FROM vehicle_makes WHERE slug = 'toyota' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Bolt',            'chevrolet-bolt',            'bolt'           FROM vehicle_makes WHERE slug = 'chevrolet' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Ariya',      'nissan-ariya',      'ariya'      FROM vehicle_makes WHERE slug = 'nissan' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Maxima',     'nissan-maxima',     'maxima'     FROM vehicle_makes WHERE slug = 'nissan' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Z',          'nissan-z',          'z'          FROM vehicle_makes WHERE slug = 'nissan' ON CONFLICT DO NOTHING;

-- ── Jeep ─────────────────────────────────────────────────────
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Cherokee',        'jeep-cherokee',        'cherokee'       FROM vehicle_makes WHERE slug = 'jeep' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Mazda6', 'mazda-mazda6', 'mazda6' FROM vehicle_makes WHERE slug = 'mazda' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'M5',        'bmw-m5',        'm5'       FROM vehicle_makes WHERE slug = 'bmw' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'EQE Sedan',     'mercedes-benz-eqe-sedan',    'eqesedan'     FROM vehicle_makes WHERE slug = 'mercedes-benz' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'EQE SUV',       'mercedes-benz-eqe-suv',      'eqesuv'       FROM vehicle_makes WHERE slug = 'mercedes-benz' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'EQS Sedan',     'mercedes-benz-eqs-sedan',    'eqssedan'     FROM vehicle_makes WHERE slug = 'mercedes-benz' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'EQS SUV',       'mercedes-benz-eqs-suv',      'eqssuv'       FROM vehicle_makes WHERE slug = 'mercedes-benz' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, '500',        'fiat-500',        '500'       FROM vehicle_makes WHERE slug = 'fiat' ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Gravity', 'lucid-gravity', 'gravity' FROM vehicle_makes WHERE slug = 'lucid' ON CONFLICT DO NOTHING;

-- ── Polestar ─────────────────────────────────────────────────
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Polestar 2', 'polestar-2', 'polestar2' FROM vehicle_makes WHERE slug = 'polestar' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Polestar 3', 'polestar-3', 'polestar3' FROM vehicle_makes WHERE slug = 'polestar' ON CONFLICT DO NOTHING;

-- ── Pontiac (discontinued — active owner community) ──────────
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'G6',        'pontiac-g6',        'g6'        FROM vehicle_makes WHERE slug = 'pontiac' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'G8',        'pontiac-g8',        'g8'        FROM vehicle_makes WHERE slug = 'pontiac' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Grand Prix','pontiac-grand-prix','grandprix' FROM vehicle_makes WHERE slug = 'pontiac' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Solstice',  'pontiac-solstice',  'solstice'  FROM vehicle_makes WHERE slug = 'pontiac' ON CONFLICT DO NOTHING;

-- ── Saturn ───────────────────────────────────────────────────
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Aura', 'saturn-aura', 'aura' FROM vehicle_makes WHERE slug = 'saturn' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Ion',  'saturn-ion',  'ion'  FROM vehicle_makes WHERE slug = 'saturn' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'Vue',  'saturn-vue',  'vue'  FROM vehicle_makes WHERE slug = 'saturn' ON CONFLICT DO NOTHING;

-- ── Scion ────────────────────────────────────────────────────
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'FR-S', 'scion-fr-s', 'frs' FROM vehicle_makes WHERE slug = 'scion' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'tC',   'scion-tc',   'tc'  FROM vehicle_makes WHERE slug = 'scion' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'xB',   'scion-xb',   'xb'  FROM vehicle_makes WHERE slug = 'scion' ON CONFLICT DO NOTHING;

-- ── Hummer ───────────────────────────────────────────────────
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'H2', 'hummer-h2', 'h2' FROM vehicle_makes WHERE slug = 'hummer' ON CONFLICT DO NOTHING;
INSERT INTO vehicle_models (make_id, name, slug, normalized_name) SELECT id, 'H3', 'hummer-h3', 'h3' FROM vehicle_makes WHERE slug = 'hummer' ON CONFLICT DO NOTHING;

-- ── Aliases ──────────────────────────────────────────────────
-- Compound make+model search terms and common abbreviations.
-- normalized_alias must match normalizeQuery() in src/features/vehicles/utils.ts
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Honda CRV',           'hondacrv',         true FROM vehicle_models WHERE slug = 'honda-cr-v'          ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Honda CRV Hybrid',    'hondacrvhybrid',   true FROM vehicle_models WHERE slug = 'honda-cr-v'          ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Toyota RAV4',         'toyotarav4',       true FROM vehicle_models WHERE slug = 'toyota-rav4'         ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Toyota 4Runner',      'toyota4runner',    true FROM vehicle_models WHERE slug = 'toyota-4runner'      ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Ford F-150',          'fordf150',         true FROM vehicle_models WHERE slug = 'ford-f-150'          ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'F-150 4x4',           'f1504x4',          true FROM vehicle_models WHERE slug = 'ford-f-150'          ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Tesla Model 3',       'teslamodel3',      true FROM vehicle_models WHERE slug = 'tesla-model-3'       ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Tesla Model Y',       'teslamodely',      true FROM vehicle_models WHERE slug = 'tesla-model-y'       ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'BMW 3',               'bmw3',             true FROM vehicle_models WHERE slug = 'bmw-330i'            ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'BMW 3 Series',        'bmw3series',       true FROM vehicle_models WHERE slug = 'bmw-330i'            ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'BMW 5 Series',        'bmw5series',       true FROM vehicle_models WHERE slug = 'bmw-530i'            ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Jeep Grand Cherokee', 'jeepgrandcherokee',true FROM vehicle_models WHERE slug = 'jeep-grand-cherokee' ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'JGC',                 'jgc',              true FROM vehicle_models WHERE slug = 'jeep-grand-cherokee' ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Hyundai Santa Fe',    'hyundaisantafe',   true FROM vehicle_models WHERE slug = 'hyundai-santa-fe'    ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Kia Telluride',       'kiatelluride',     true FROM vehicle_models WHERE slug = 'kia-telluride'       ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Ram 1500',            'ram1500',          true FROM vehicle_models WHERE slug = 'ram-1500'            ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Ram Truck',           'ramtruck',         true FROM vehicle_models WHERE slug = 'ram-1500'            ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Mazda CX-5',          'mazdacx5',         true FROM vehicle_models WHERE slug = 'mazda-cx-5'          ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Subaru WRX',          'subaruwrx',        true FROM vehicle_models WHERE slug = 'subaru-wrx'          ON CONFLICT (normalized_alias) DO NOTHING;
INSERT INTO vehicle_aliases (vehicle_model_id, alias, normalized_alias, is_manual) SELECT id, 'Hyundai Ioniq',       'hyundaiioniq',     true FROM vehicle_models WHERE slug = 'hyundai-ioniq-5'     ON CONFLICT (normalized_alias) DO NOTHING;
